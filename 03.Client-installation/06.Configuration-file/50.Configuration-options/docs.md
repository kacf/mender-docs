...
This setting controls which command is used to get information about the
...
This setting controls which command is used to set the active rootfs partition,
